...
<@layout.main_layout title="Моё чтение">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <div>
            <h1 style="margin: 0; font-size: 2rem; font-weight: 800; color: #111827;">Моё чтение</h1>
            <p style="color: #64748b; margin-top: 0.5rem;">Ваш прогресс и список читаемых книг</p>
        </div>
    </div>
    ...
    <#if readingList?has_content>
            ...
            <#list readingList as progress>
                <div class="card" style="display: flex; flex-direction: column; height: 100%; animation: staggerIn ${(progress_index * 0.1) + 0.2}s ease-out both;">
                    ...
                    <div style="padding: 0 1.25rem 1.25rem 1.25rem; display: flex; flex-direction: column; gap: 0.75rem; margin-top: auto;">
                        ...
                        <a href="/reader/${progress.bookId?c}" class="cta" style="margin-top: 0;">Читать дальше</a>
                    </div>
                </div>
            </#list>
        </div>
        ...
        <div class="card" style="padding: 2rem; margin-bottom: 2rem;">
            ...
            <div style="margin-top: 1rem; padding-top: 1rem; border-top: 1px solid #e2e8f0; color: #64748b; font-size: 0.9rem;">
                На графике отображен прогресс чтения (в страницах) для последних активных книг.
            </div>
        </div>
    <#else>
        <div class="card" style="padding: 4rem; text-align: center; background: white;">
            <div style="font-size: 4rem; margin-bottom: 1rem;">📖</div>
            <h2 style="margin-top: 0; color: #1e293b;">Список чтения пуст</h2>
            <p style="color: #64748b; max-width: 400px; margin: 0 auto 2rem;">Начните читать книги из вашей библиотеки, и они появятся здесь вместе с вашим прогрессом.</p>
            <a href="/" class="btn btn-primary">Перейти в библиотеку</a>
        </div>
    </#if>
</@layout.main_layout>
