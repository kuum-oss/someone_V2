...
### 2. Облачное хранилище (Storage)
*   **Путь к файлам:** Директория `storage/` в корне проекта.
*   **Структура:** `storage/user_{id}/` — файлы каждого пользователя изолированы в своей папке.
*   **Лимиты:** На каждого пользователя установлено ограничение в **5 ГБ**. При достижении лимита загрузка новых книг блокируется.
